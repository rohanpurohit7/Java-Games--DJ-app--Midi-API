...
public class musicbox {
	...
	public void buildGUI(){
		...
		JButton deserealizeIt = new JButton("Retrieve pattern");
		deserealizeIt.addActionListener(new MyReadInListener());
		buttonBox.add(deserealizeIt);
